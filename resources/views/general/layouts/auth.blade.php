...
<html lang="zxx">
    ...
    <!-- Mirrored from storage.googleapis.com/themevessel-products/logdy/main/login-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Jul 2019 13:44:38 GMT -->
    ...
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="{{asset('files/fonts/flaticon/font/flaticon.css')}}">

        <!-- Favicon icon -->
        <link rel="shortcut icon" href="{{asset('files/img/favicon.ico')}}" type="image/x-icon">
        ...
        <link rel="stylesheet" type="text/css" id="style_sheet" href="{{asset('files/css/skins/default.css')}}">

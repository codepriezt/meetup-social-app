            ...
            <div class="post-bar">
                <div class="post_topbar">
                    <div class="usy-dt">
                        ...
                        <div class="usy-name">
                        <h3>{{$post->user->getfullNameOrUsername()}}</h3>
                            <span><img src="{{asset('folder/images/clock.png')}}" alt="">3 min ago</span>
                        </div>
                    </div>
                    <div class="ed-opts">
                ...
                <div class="job-status-bar">
                    <ul class="like-com">
                       <li>
                        ...
                        <li><a href="" class="com"><img src="images/com.png" alt=""> Comment
